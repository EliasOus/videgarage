    ...
    <>
      <div className={style.footer}>
        ...
        <div className={style.reseaux}>
            ...
            <div>
                <a href="#"><Image src={facebook} alt="logo facebook"/></a>
                <a href="#"><Image src={instagram} alt="logo instagram"/></a>
                <a href="#"><Image src={twitter} alt="logo twitter"/></a>
                <a href="#"><Image src={whatsapp} alt="logo whatsapp"/></a>
            </div>
        </div>
